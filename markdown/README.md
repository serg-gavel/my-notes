...
Код в строке: 
![alt-текст](https://github.com/serg-gavel/serg-gavel.github.io/blob/master/favicon.ico "Текст заголовка логотипа 1")

Reference-style: 
![alt-текст][logo]

[logo]: https://github.com/serg-gavel/serg-gavel.github.io/blob/master/favicon.ico "Текст заголовка логотипа 2"
```
